...
--init replay memory
local replay_memory = {}
local expert_experience = torch.load('./finetune_model/expert_experience')
expert_experience = expert_experience.replay_memory
--init reward
local reward = 0
...
local optimState = {learningRate = opt.lr, maxIteration = 1, learningRateDecay = 0.00009, evalCounter = 0}
